...
toggle.onclick = function(event){
  if(event.target.checked == true){
    ...
    header.style.boxShadow = "0 -1rem 4rem 0 rgba(220, 222, 224, 0.4)";
    showCase.style.background = "#2E3440";
    showCaseInput.style.color = "#ECEFF4";
    ...
    header.style.boxShadow = "0 -1rem 4rem 0 rgba(46, 52, 64, 0.4)";
    showCase.style.background = "#ECEFF4";
    showCaseInput.style.color = "#2E3440";
